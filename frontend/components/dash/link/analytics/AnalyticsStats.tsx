...
const AnalyticsStats: React.FC<AnalyticsStatsProps> = ({ analytics, view, onViewChange, link }) => {
    return (
        <div className="flex w-full flex-col lg:flex-row gap-2 lg:gap-4 h-20">
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-3 sm:gap-4">
                <button
                    ...
                    className={`group cursor-pointer py-2 pl-4 pr-6 rounded-xl transition-all duration-200 hover:scale-[1.01] ${view === 'clicks'
                ...
                <button
                    ...
                    className={`group cursor-pointer py-2 pl-4 pr-6 rounded-xl transition-all duration-300 hover:scale-[1.01] ${view === 'users'
