        ...
        <div className="flex-1 lg:max-w-lg flex items-center gap-2">
            <div className="flex-1 relative flex items-center">
                <input
                    ...
                    className="font-semibold w-full px-4 py-2.5 pl-11 bg-white/10 backdrop-blur-xl border-1 border-[#D3D3D3] rounded-full text-[#0054A5] focus:border-[#0054A5] focus:border-1 focus:outline-none"
                />
