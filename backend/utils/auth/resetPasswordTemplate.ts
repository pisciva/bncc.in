      ...
      <div style="background:rgba(255,255,255,0.15);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid #D3D3D3;border-radius:16px;overflow:hidden;">
        ...
        <div style="padding:32px;">
          ...
          <div style="text-align:center;margin:25px 0;">
            <a href="${resetLink}" style="display:inline-block;padding:10px 30px;background:#0054A5;color:#ffffff;font-size:16px;font-weight:600;text-decoration:none;border-radius:1000px;">
              Reset My Password
            </a>
          </div>
